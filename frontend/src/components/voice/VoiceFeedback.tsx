...
export function VoiceFeedback({
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-fade-in-up">
      <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-[#100a0a]/95 border border-white/[0.08] backdrop-blur-xl shadow-2xl shadow-[#FF8F00]/10">
        ...
        {isListening && (
          <>
            <div className="relative">
              ...
              <div className="absolute inset-0 rounded-full bg-[#FFB347]/20 animate-ping" />
            </div>
