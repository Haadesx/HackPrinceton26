...
export function InlineStudyGuide({ content }: InlineStudyGuideProps) {
  ...
  return (
    <div className="mt-2 rounded-xl border border-orange-500/20 bg-orange-500/[0.05] overflow-hidden w-[500px] max-w-full">
      {/* Header */}
      ...
      <div className="px-4 py-3 max-h-[500px] overflow-y-auto overscroll-contain">
        <div className="prose prose-invert prose-sm max-w-none text-white/80 prose-headings:text-[#FFCDD6] prose-a:text-[#FFD08A] prose-code:text-[#FFD08A] prose-pre:bg-white/[0.04] prose-pre:border prose-pre:border-white/[0.06] prose-pre:text-[#FFD08A]">
