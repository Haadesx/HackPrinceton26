                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full text-[10px] font-mono tracking-[0.08em] uppercase transition-all duration-300 ${
                    graphFilters.viewMode === mode.id
                      ? "bg-orange-500/20 text-orange-400 shadow-[0_0_12px_rgba(232,69,69,0.2)]"
        ...
        {currentView === "home" && (
          <>
            ...
            >
              ...
              <span>Filters</span>
              {activeCount > 0 && (
                <span className="ml-1 px-1.5 py-0.5 rounded-full bg-orange-500/30 text-orange-300 text-[9px] font-bold">
                  {activeCount}
                </span>
              )}
              <ChevronUp
            ...
            <Toggle
              ...
              className="rounded-full h-8 h-8 data-[state=on]:bg-orange-500/20 data-[state=on]:text-orange-400 text-white/40 hover:text-white/70 transition-all duration-300"
            >
