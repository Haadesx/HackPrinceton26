...
export function StudyLab({ onClose }: StudyLabProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Panel */}
      <div className="relative w-full max-w-2xl max-h-[80vh] mx-4 flex flex-col rounded-2xl border border-white/[0.08] bg-[#100a0a]/95 backdrop-blur-xl shadow-2xl shadow-[#CC0033]/5 animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
        <div className="flex items-center gap-3 px-5 py-4 border-b border-white/[0.06] shrink-0">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#CC0033] to-[#A41E35] flex items-center justify-center">
