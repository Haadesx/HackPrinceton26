  ...
  if (showResults) {
    ...
    return (
      <div className="flex flex-col items-center gap-6 py-4">
        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#CC0033]/20 to-[#A41E35]/20 flex items-center justify-center">
          <Trophy size={36} className="text-[#FFCDD6]" />
        </div>
        ...
        <button
          onClick={restart}
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#A41E35] hover:bg-[#CC0033] text-white text-sm transition-all"
        >
          <RotateCcw size={14} />
          Retry Quiz
        </button>
    ...
    <div className="flex flex-col gap-6">
      ...
      {isAnswered && (
        <div className="space-y-4 animate-fade-in-up">
          ...
          <button
            onClick={handleNext}
            className="w-full py-3 rounded-xl bg-[#A41E35] hover:bg-[#CC0033] text-white text-sm font-medium transition-all"
          >
