...
export function InlineQuiz({ questions }: InlineQuizProps) {
  ...
  if (showResults) {
    ...
    return (
      <div className="mt-2 rounded-xl border border-[#CC0033]/20 bg-[#CC0033]/[0.05] overflow-hidden">
        <div className="flex items-center justify-between px-3 py-2 border-b border-white/[0.06]">
          <span className="text-[10px] font-mono text-[#FFCDD6]/70 uppercase tracking-wider">Quiz Results</span>
          <button
            onClick={restart}
        ...
        <div className="px-4 py-3 flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#CC0033]/20 to-[#A41E35]/20 flex items-center justify-center shrink-0">
            <Trophy size={18} className="text-[#FFCDD6]" />
          </div>
          <div>
  ...
  return (
    <div className="mt-2 rounded-xl border border-[#CC0033]/20 bg-[#CC0033]/[0.05] overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between px-3 py-2 border-b border-white/[0.06]">
        <span className="text-[10px] font-mono text-[#FFCDD6]/70 uppercase tracking-wider">
          Quiz
        </span>
      ...
      <div className="px-3 pb-3 space-y-1.5">
        ...
        {isAnswered && (
          <div className="space-y-2 pt-1 animate-fade-in-up">
            ...
            <button
              onClick={handleNext}
              className="w-full py-2 rounded-lg bg-[#A41E35] hover:bg-[#CC0033] text-white text-xs font-medium transition-all"
            >
