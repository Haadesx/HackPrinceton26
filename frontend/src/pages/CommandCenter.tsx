                  ...
                  >
                    <div className="shrink-0 flex items-center justify-center w-8 h-8 rounded-full overflow-visible relative">
                      <div className="absolute inset-0 flex items-center justify-center" style={{ transform: 'scale(0.28)' }}>
                        <SyllaraOrb isSpeaking={isPlaying} isBriefAvailable={false} onClick={() => {}} isLoading={false} />
                      </div>
                    </div>
                        ...
                        <div className="flex flex-col gap-6 flex-1 min-w-0">
                          <div>
                            <div className="flex items-center gap-3 mb-3">
                              ...
                              <span className="text-[10px] font-mono tracking-[0.2em] text-white/30 uppercase">Mission Brief</span>
                            </div>
                            <h2 className="text-xl font-medium text-white/95 tracking-tight mb-1">
                              {greetingLine}, Jane.
                            </h2>
                            <p className="text-[13px] text-white/40 leading-relaxed">
                              Today is {todayStr}. Here's your reasoning summary.
                            </p>
                          </div>
                      ...
                      {loading && messages[messages.length - 1]?.content === "" && (
                        <div className="flex justify-start">
                          <div className="bg-white/[0.04] border border-white/[0.06] rounded-xl px-4 py-2.5">
                            <Loader2 size={14} className="animate-spin text-[#FFCDD6]" />
                          </div>
                        </div>
                      )}
                      <div ref={bottomRef} />
...
function BriefItem({
  ...
  const colors = {
    danger: { dot: "bg-orange-400", text: "text-white/60", meta: "text-orange-400/70" },
