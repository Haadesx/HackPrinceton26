        ...
        >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-orange-500/10 border border-orange-500/20">
                  {activeArtifact === "flashcards" && <Brain size={12} className="text-orange-400" />}
                  {activeArtifact === "quiz" && <HelpCircle size={12} className="text-orange-400" />}
                  {activeArtifact === "study-guide" && <BookOpen size={12} className="text-orange-400" />}
                  <span className="text-[11px] text-orange-400 font-medium">{artifactLabel}</span>
                </div>
          ...
          <div className="flex-1 overflow-y-auto min-h-0">
            <div className="px-6 py-5">
              ...
              {/* Error */}
              {artifactError && (
                <div className="px-4 py-3 rounded-xl bg-orange-500/10 border border-orange-500/20 text-sm text-orange-400 mb-4">
                  {artifactError}
                  <button
                    onClick={() => handleGenerateArtifact(activeArtifact!)}
                    className="block mt-2 text-xs text-orange-300 hover:text-orange-200 underline transition-colors"
                  >
                    Try again
                  </button>
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  {saved?.flashcards && (
                    <button
                      ...
                      className="flex items-center gap-2.5 px-3 py-2 rounded-xl border border-orange-500/15 bg-orange-500/[0.04] text-white/60 hover:text-white/90 hover:bg-orange-500/10 transition-all w-full text-left"
                    >
                      <Brain size={13} className="text-orange-400/70 shrink-0" />
                  ...
                  {saved?.quiz && (
                    <button
                      ...
                      className="flex items-center gap-2.5 px-3 py-2 rounded-xl border border-orange-500/15 bg-orange-500/[0.04] text-white/60 hover:text-white/90 hover:bg-orange-500/10 transition-all w-full text-left"
                    >
                      <HelpCircle size={13} className="text-orange-400/70 shrink-0" />
                      <div className="flex-1 min-w-0">
                  ...
                  {saved?.studyGuide && (
                    <button
                      ...
                      className="flex items-center gap-2.5 px-3 py-2 rounded-xl border border-orange-500/15 bg-orange-500/[0.04] text-white/60 hover:text-white/90 hover:bg-orange-500/10 transition-all w-full text-left"
                    >
                      <BookOpen size={13} className="text-orange-400/70 shrink-0" />
                      <div className="flex-1 min-w-0">
              ...
              <div className="grid grid-cols-3 gap-1.5 mb-4">
                {[
                  ...
                  <button
                    ...
                    className="flex flex-col items-center gap-1.5 p-2.5 rounded-xl border border-white/[0.06] bg-white/[0.02] text-white/40 hover:text-white/80 hover:bg-orange-500/10 hover:border-orange-500/30 transition-all group"
                  >
                    <Icon size={16} className="group-hover:text-orange-400 transition-colors" />
            ...
            <section className="space-y-2">
              ...
              {(conceptArtifacts[concept.id] as { agentUrl?: string } | undefined)?.agentUrl ? (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-1.5 h-9 px-3 rounded-md text-[11px] font-medium bg-orange-500/20 text-orange-300 hover:bg-orange-500/30 transition-all border border-orange-500/30"
                >
                  <Cpu size={12} />
                ...
                <>
                  <Button
                    ...
                    className="w-full text-[11px] h-9 border-orange-500/20 text-orange-400/70 hover:text-orange-300 hover:bg-orange-500/10"
                  >
                    {buildingAgent ? (
