      ...
      >
        ...
        <SheetHeader className="px-6 pt-6 pb-4">
          <div className="flex items-center gap-3">
            ...
            <SheetTitle className="text-orange-400 text-sm font-mono tracking-[0.1em] uppercase">
              ...
              <div>
                ...
                <div className="glass-card p-4 mb-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className={`text-2xl font-bold ${scorePercent < 60 ? "text-orange-400" : "text-amber-400"}`}>
                      {scorePercent}%
                    </span>
                  </div>
                ...
                <div className="space-y-1.5">
                  {plan.conceptsMissed.map((concept, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-2 px-3 py-2 rounded-lg bg-orange-500/[0.04] border border-orange-500/[0.08]"
                    >
                      ...
                      <div key={i} className="relative flex gap-3">
                        ...
                        <div className="relative z-10 mt-0.5 shrink-0">
                          {step.status === "completed" ? (
                            ...
                            <div className="w-[22px] h-[22px] rounded-full bg-[#FF8F00]/20 border border-[#FF8F00]/40 flex items-center justify-center animate-pulse">
                              <Loader2 size={10} className="text-[#FFB347] animate-spin" />
                            </div>
                          ) : (
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 py-4 border-t border-white/[0.06] bg-[#100a0a]/90 backdrop-blur-md">
          <div className="flex items-center gap-3">
            <Button
              className="flex-1 glow-button bg-[#E77500] hover:bg-[#FF8F00] text-white font-mono text-[12px] tracking-wider"
              onClick={() => {
