  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-5 py-6">
        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#CC0033] to-[#A41E35] flex items-center justify-center shrink-0 glow-indigo">
      ...
      <div className={`px-4 pb-5 space-y-2.5 ${collapsed ? "px-3" : ""}`}>
        ...
        <div className="flex flex-col gap-2">
          {([
            ["canvasApi", "Canvas Sync"],
            ["terpAiBridge", "K2 Core"],
            ["ghostPilot", "Inference Loop"],
