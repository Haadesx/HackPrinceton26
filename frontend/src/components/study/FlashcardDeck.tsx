    ...
    <div className="flex flex-col items-center gap-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="w-40 h-1 bg-white/[0.06] rounded-full overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-[#CC0033] to-[#CC0033] rounded-full transition-all duration-300"
      ...
      >
        ...
        >
          {/* Front */}
          <div
            className="absolute inset-0 rounded-2xl border border-white/[0.08] bg-gradient-to-br from-[#CC0033]/10 to-[#A41E35]/10 backdrop-blur-xl flex items-center justify-center p-8"
          ...
          {/* Back */}
          <div
            className="absolute inset-0 rounded-2xl border border-white/[0.08] bg-gradient-to-br from-[#A41E35]/10 to-[#CC0033]/10 backdrop-blur-xl flex items-center justify-center p-8"
            style={{
