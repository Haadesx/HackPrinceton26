...
export function Chat({ onClose: onCloseProp }: ChatProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Chat Panel */}
      <div className="relative w-[95vw] max-w-6xl h-[85vh] mx-4 flex flex-col rounded-2xl border border-white/[0.08] bg-[#100a0a]/95 backdrop-blur-xl shadow-2xl shadow-[#CC0033]/5 animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
        <div className="flex items-center gap-3 px-5 py-4 border-b border-white/[0.06] shrink-0">
          <div className={`w-8 h-8 rounded-lg flex items-center justify-center bg-gradient-to-br ${
            tab === "chat" ? "from-[#CC0033] to-[#A41E35]" : "from-[#CC0033] to-[#A41E35]"
          }`}>
            {tab === "chat"
          ...
          {specializedAgentLabel && (
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-orange-500/15 border border-orange-500/25 text-orange-300">
              <Cpu size={10} />
          ...
          <AnimatePresence mode="wait">
            ...
            {tab === "chat" && (
              ...
              >
                <div className="flex-1 overflow-y-auto min-h-0 px-5 py-4 space-y-4">
                  {messages.length === 0 && (
                    <div className="flex flex-col items-center justify-center h-full text-center">
                      <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#CC0033]/20 to-[#A41E35]/20 flex items-center justify-center mb-4">
                      ...
                      {!specializedAgentLabel && (
                        <div className="flex flex-wrap gap-2 mt-4 justify-center">
                          {[
                            ...
                            "Explain max-flow reductions simply",
                            "Quiz me on virtual memory",
                            "Study plan for the 16:198:533 final paper",
                          ].map((suggestion) => (
                            <button
                              key={suggestion}
                ...
                {/* Listening indicator */}
                {isListening && (
                  <div className="px-5 py-2 border-t border-white/[0.06] bg-[#CC0033]/[0.08] shrink-0">
                ...
                {(isSpeaking || isSpeakLoading) && !isListening && (
                  <div className="px-5 py-2 border-t border-white/[0.06] bg-[#CC0033]/[0.08] shrink-0">
                    <div className="flex items-center gap-2">
                      {isSpeakLoading
                        ? <Loader2 size={12} className="animate-spin text-[#FFCDD6]" />
                ...
                <div className="px-5 py-4 border-t border-white/[0.06] shrink-0">
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-4 rounded-xl bg-[#A41E35] hover:bg-[#CC0033] disabled:bg-white/[0.06] disabled:text-white/20 text-white transition-all"
                    >
                      <Send size={18} />
                    </button>
                  </div>
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <button
                        ...
                        className={`flex items-center gap-1.5 px-2 py-1 rounded-md text-[11px] font-mono transition-all ${
                          conversationMode
                            ? "bg-[#CC0033]/20 text-[#FFD08A] border border-[#CC0033]/30"
